...
export default function Home() {
    return (
        <Layout title="전제룡 - 기술 이력서" description="소통과 배려, 공감을 통해 팀과 함께 성장하며 가치있는 비즈니스를 실현할 수 있는 준비된 인재가 되기위해 노력하고 있습니다.">
            ...
            <section className="flex flex-col text-xl text-gray-700 leading-[1.8] gap-y-[24px] max-md:text-base">
                <p>
                    코드로 시각적인 결과를 만들어 내는 일에 큰 즐거움을 느끼고, 아름답고 특별한 인터페이스와 동적인 그래픽 구현을 즐기는 열정 가득한 신입 프론트엔드 개발자입니다.
                </p>
                <p>
                    개발은 비즈니스를 구현하는 일이라고 이해하고 있습니다. 비즈니스의 성장과 팀에 기여하기 위해 적극적인 커뮤니케이션과 스스로 끊임없이 발전하려는 노력이 필요하다 믿으며, 준비된 인재가 되기 위해 노력하고 있습니다.
                </p>
                <p>
                    소통과 공감은 사람과의 관계에서 저에게 가장 중요한 가치이며, 함께 만들어 가는 과정을 통해 성장하고 건강한 커뮤니케이션을 통해 수준높은 결과를 만들 수 있다는 것을 경험 하였고, 평소 상대의 감정에 배려하고 주변에 밝고 긍정적인 에너지를 전달하려 노력합니다.
                </p>
            </section>
                ...
                <div className="flex flex-col mt-[52px] gap-y-[44px]">
                    ...
                    >
                        <ExperiencedProjectDetail
                            ...
                            addFields={[
                                { title: 'Used Stack', content: 'ReactQuery, Zustand, Ubuntu Linux, PM2' }
                            ]}
                        />
                        ...
                        <ExperiencedProjectDetail
                            ...
                            addFields={[
                                { title: 'Review', content: <>
                                        프로젝트 초기에 과한 열정으로 일정 대비 너무 많은 작업량을 맡거나 문제를 혼자서만 해결하려 하다 팀 일정에 차질을 주어 문제를 겪은적이 있습니다.<br/>
                                        <br/>
                                        이때 커뮤니케이션의 중요성과 함께 일을 한다는 의미를 좀 더 깊게 깨닫게 되었고, 적극적인 소통을 통해 작업을 분배하고
                                        실현 가능한 일정을 계획하여 팀 작업 일정을 앞당겨 문제를 개선한 경험이 있습니다. 이후로 상황과 생각을 공유하고 보완하는 자세로 임하려 노력하고 있습니다.
                                        <br/>
                                        <br/>
                                        또한, 주요 기획에 해당하는 유튜브 플레이어 커스텀에 대한 저작권 문제의 여지를 파악하여 검증된 자료를 찾아
                    ...
                    >
                        <ExperiencedProjectDetail
                            ...
                            addFields={[ { title: 'Used Stack', content: 'TypeScript, React, Redux Toolkit, Tailwind CSS' } ]}
                        />
                    ...
                    >
                        <ExperiencedProjectDetail
                            ...
                            addFields={[ { title: 'Used Stack', content: 'Swagger, Openapi Generator' } ]}
                        />
                    ...
                    >
                        <div className="flex flex-col gap-y-3">
                            {[
                                {title: "NestJS로 API 만들기", stack: "(TypeScript, NestJS)", description: '모듈형식의 아키텍처를 제공하는 NodeJS기반의 백엔드 프레임워크 학습', git: 'https://github.com/zeriong/nest_intro'},
                                {title: "NextJS 시작하기", stack: "(NextJS)", description: 'SSR와 SEO의 개념을 이해하고 NextJS프레임워크의 작동 방식 학습', git: 'https://github.com/zeriong/nextjs_intro'},
                                {title: "트위터 클론코딩", stack: "(React, Firebase)", description: 'React 심화 학습과 서버리스의 개념, 실시간 업데이트, OAuth2.0 등 핵심 기능 학습', git: 'https://github.com/zeriong/zwitter', demo: 'https://zeriong.github.io/zwitter/'},
                                {title: "초보자를 위한 리덕스 101", stack: "(React, Redux, Redux-Toolkit)", description: '상태관리에 대한 개념과 Redux의 작동 방식 학습', git: 'https://github.com/zeriong/vanilla-react-redux'},
                                {title: "실전형 리액트 Hooks", stack: "(React Hook)", description: '기본적인 React Hooks에 대한 개념을 이해하고 Custom Hooks를 만들며 학습', git: 'https://github.com/zeriong/Hooks'},
                                {title: "React로 영화 웹 서비스 만들기", stack: "(React, gh-pages)", description: 'React의 기본적인 작동 방식 학습과 Github의 gh-pages를 통한 배포를 경험하며 학습', git: 'https://github.com/zeriong/movie_app', demo: 'https://zeriong.github.io/movie_app/'},
                                {title: "바닐라 JS로 그림앱 만들기", stack: "(Vanilla JS, CSS)", description: 'canvas의 기초적인 기능 구현을 통해 Vanilla JS 기초 학습', git: 'https://github.com/zeriong/paint_app'},
                                {title: "바닐라 JS로 크롬 앱 만들기", stack: "(Vanilla JS)", description: 'if문 활용, Local Storage, Fetch를 통한 API사용법 등 Vanilla JS의 기본기 심화 학습', git: 'https://github.com/zeriong/learning-start/tree/main/04.nomad-corders/momentum_app'},
                            ].map((item, idx) => (
                                <div key={idx}>
                    ...
                    >
                        <div className="flex flex-col gap-y-3">
                            {[
                                ...
                                {
                                    title: "02. grid",
                                    description: "CSS에 대한 이해와 기본적인 레이아웃, 그리드 구성 숙달을 위해 진행한 내용입니다.",
                                    git: 'https://github.com/zeriong/learning-start/tree/main/02.grids',
                                    list: [
                                        { title: "AppStack, OverWatch, Slack, The Noun Project, Twitch, Youtube", description: "각기 다른 유형의 레이아웃을 가진 6개의 사이트를 반응형 레이아웃과 그리드만을 클로닝하며 학습" },
                                    ]
                                },
                                {
                                    title: "01. practice",
                                    description: "HTML, CSS, JS 에 대한 기초적인 이해를 위해 진행한 내용입니다.",
                                    git: 'https://github.com/zeriong/learning-start/tree/main/01.practice',
                                    list: [
                                        { title: "slider-sample", description: "슬라이더를 구현하며 CSS와 JS 심화 학습" },
                                        { title: "ze_monster", description: "JS 숙련을 위해 몬스터를 잡고 레벨업을 하는 간단한 기능을 구현" },
                                        { title: "JS_Practice", description: "JS에 대한 학습자료를 찾아 메모하며 적용" },
                                        { title: "calculator", description: "계산기를 구현해보며 조금 더 심화된 JS 학습" },
                                        { title: "web_site_cloning", description: "유튜브 강의로 웹페이지 클로닝을 진행하며 HTML, CSS, JS를 통해 웹페이지 구현" },
                                    ]
                                },
                            ].map((chapter, idx) => (
            ...
            <Category
                ...
                description={
                    <>
                        ...
                        필요한 전반적인 과정을 경험하고 문제를 해결하며 이해하고 성장하는 데 중점을 두었습니다. 백엔드에서는 <span className="border-b-2 border-blue-500">NestJS</span> 사용에 익숙합니다.
                    </>
                }
            >
